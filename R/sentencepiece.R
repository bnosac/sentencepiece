...
#' model <- sentencepiece("traindata.txt", type = "unigram", vocab_size = 5000)
#' model <- sentencepiece("traindata.txt", type = "char", vocab_size = 5000)
#' model <- sentencepiece("traindata.txt", type = "bpe", vocab_size = 5000)
#' 
